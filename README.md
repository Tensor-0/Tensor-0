...
专注于复杂异构硬件架构下的高动态运动控制，与轮足式/双足机器人的 Sim-to-Real 物理实体部署。
擅长在极度受限的算力与物理边界下，完成从**动力学建模 (Kinematics/Dynamics)** 到**多总线实时网络 (Real-time Bus Topology)**，再到**敏捷工程交付 (Agile Commissioning)** 的全链路系统闭环。不迷信纯理论仿真，追求物理世界的鲁棒性。
